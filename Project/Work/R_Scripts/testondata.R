source('/Users/Thomas/Dropbox/DS_GROUP/15D012 - Advanced Computational Methods/Work/R-Scripts/Thomas/TriesFinalPRED.R')
...
#training set without the outliers referenced in outliers_id
data <- data[-scan('outliers_id'),]
PRED(data, 'popularity', test, 2)